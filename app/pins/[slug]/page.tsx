...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `Discover the ${data[0].name} in Counter-Strike 2. Check current Steam market prices, explore pin details, get in-depth information and more for this pin.`,
    alternates: {
      canonical: `/pins/${slug}`,
    },
    openGraph: {
